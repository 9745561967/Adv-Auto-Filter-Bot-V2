                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '✅ Join Our Channels ✅', url="https://t.me/AM_NewRelease"
                                )
                        ]
                    ]
                )
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('👤 Admin', url='https://t.me/Muhdaslamp'),
        InlineKeyboardButton('Admin👤', url='https://t.me/Dulquer_jin')
    ],[
        InlineKeyboardButton('👤 Owner 👤', url='https://t.me/mhdriyaskt')
    ],[
